# Task T015 — Register server metadata

**Epic:** EPIC 2 — MCP Server (FastMCP)
**Story:** Story 2.1 — FastMCP Server Bootstrap
**Source:** docs/tasks/epics.md

## Goal
Expose server name, version, and capabilities metadata.
